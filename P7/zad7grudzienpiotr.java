...
public class KalkulatorTest
{
	...
	@Test
	public void MutlipleAdditions()
	{
		AddingAccumulatorA();
		assertEquals("addA(4) nie zwraca oczekiwanej zawartosci  akumulatora A", 4, ki.addA(4) );
	...
	@Test
	public void NMutlipleAdditions()
	{
		AddingAccumulatorA();
		assertEquals("addA(-4) nie zwraca oczekiwanej zawartosci akumulatora A", -4, ki.addA(-4) );
		assertEquals("addA(-6) wykonany po add(-4) nie zwraca oczekiwanej zawartosci akumulatora A", -10, ki.addA(-6) );
	...
	@Test
	public void MutlipleSubstractions()
	{
		AddingAccumulatorA();
		assertEquals("subA(4) nie zwraca oczekiwanej zawartosci akumulatora A", -4, ki.subA(4) );
	...
	@Test
	public void NMutlipleSubstractions()
	{
		AddingAccumulatorA();
		assertEquals("subA(-4) nie zwraca oczekiwanej zawartosci akumulatora A", 4, ki.subA(-4) );
		assertEquals("subA(-6) wykonany po subA(4) nie zwraca oczekiwanej zawartosci akumulatora A", 10, ki.subA(-6) );
	...
	public void NonChangingOp1()
	{
		...
		ki.addA(3);
		ki.subA(3);
		assertEquals("addA(3) i subA(3) nie powinny zmienic zawartosci akumulatora A", tmp, ki.getA() );
	}
	...
	public void NonChangingOp3()
	{
		...
		ki.addA(3);
		ki.addA(-3);
		assertEquals("addA(3) i addA(-3) nie powinny zmienic zawartosci akumulatora A", tmp, ki.getA() );
	}
	...
	public void NonChangingOp4()
	{
		...
		ki.subA(3);
		ki.subA(-3);
		assertEquals("subA(3) i subA(-3) nie powinny zmienic zawartosci akumulatora A", tmp, ki.getA() );
	}
