...
POSITION POSITION::operator*(const int t) const
{
	return POSITION(t*Dlugosc,t*Szerokosc);
}
...
double WORLD::distance(const AWATAR &A, const AWATAR &B) const throw(std::string)
{
